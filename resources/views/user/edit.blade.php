    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                <form action="{{ route('updt.user', $user->id)}}" method="post" class="form-item">
                @csrf 
                    <div class="form-group row">
                        <label for="" class="col-md-4 col-form-label text-md-right">Nama User</label>
                        <div class="col-md-6">
                            <input type="text" name="name" class="form-control" placeholder="Masukkan Nama" value="{{ is_null ($user) ? '' : $user->name }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="email" class="form-control" placeholder="Masukkan email" value="{{ is_null ($user) ? '' : $user->email }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="password" class="form-control @error('password') is-invalid @enderror" id="exampleInputPassword" placeholder="Isi Password Baru" name="password">
